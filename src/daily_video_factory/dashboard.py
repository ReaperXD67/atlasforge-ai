...
def create_app(settings: Settings) -> FastAPI:
    app = FastAPI(title="Daily Video Factory", version="0.1.0")
...
<title>Daily Video Factory</title><style>
...
</style></head><body><header><div><div class="muted">OPERATIONS</div><h1>Daily Video Factory</h1></div><div class="pill" id="updated">loading</div></header>
